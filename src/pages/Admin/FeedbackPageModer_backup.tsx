...
const FeedbackModerationPage: React.FC = () => {
  ...
  const rowSelection = {
    ...
    onSelectAll: (selected: boolean, _selectedRows: FeedbackDto[], changeRows: FeedbackDto[]) => {
      if (selected) {
      ...
      <div className="p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <div className="text-sm text-gray-500">відгуків знайдено</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 p-4 bg-gray-50 rounded-lg border shadow-sm">
          <div className="flex flex-wrap gap-3 items-center justify-between">
            <Space wrap size="middle">
              ...
              {selectedRows.length > 0 && (
                <>
                  ...
                  >
                    <Button danger icon={<CloseOutlined />} size="large" type="text">
            ...
            <Space wrap size="middle">
              <div className="flex items-center gap-2 px-3 py-1 bg-white rounded-md border">
        ...
        {showFilters && (
          ...
          >
            <Row gutter={[16, 16]}>
              ...
              <Col xs={24} sm={12} md={8}>
                <div className="mb-2">
                  <label className="text-sm font-medium text-gray-700">Статуси</label>
                </div>
                <Select
                  allowClear
                  mode="multiple"
              ...
              <Col xs={12} sm={6} md={4}>
                <div className="mb-2">
                  <label className="text-sm font-medium text-gray-700">Мін. рейтинг</label>
                </div>
                <InputNumber
                  placeholder="0.0"
                  min={0}
              ...
              <Col xs={12} sm={6} md={4}>
                <div className="mb-2">
                  <label className="text-sm font-medium text-gray-700">Макс. рейтинг</label>
                </div>
                <InputNumber
                  placeholder="5.0"
                  min={0}
            ...
            message={
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">
                  Знайдено <span className="text-blue-600 font-bold">{filtered.length}</span> з <span className="font-bold">{all.length}</span> відгуків за заданими критеріями
                </span>
              </div>
            }
            type="info"
        ...
        {/* Головна панель з інформацією */}
        <Card className="feedback-table shadow-lg mb-6" title={
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {selectedRows.length > 0 && (
                <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl border border-blue-200 shadow-sm">
                  <span className="text-sm font-bold text-blue-800">
                    Обрано: <span className="text-blue-600">{selectedRows.length}</span>
                  </span>
                  ...
                  <Button
                    ...
                    icon={<CheckOutlined />}
                    onClick={() => bulkStatusUpdate(selectedRows, 'approved')}
                    className="bg-green-600 border-green-600 hover:bg-green-700 shadow-sm"
                  >
                    Схвалити
                  </Button>
                  <Button
              ...
              <Tooltip title={`Автооновлення ${autoRefresh ? 'увімкнено' : 'вимкнено'}`}>
                <Button
                  ...
                  className={`shadow-sm ${autoRefresh ? 'bg-green-600 border-green-600 hover:bg-green-700' : 'border-gray-300'}`}
                >
              ...
              <Button
                ...
                icon={<DownloadOutlined />}
                onClick={exportData}
                className="bg-gradient-to-r from-orange-50 to-orange-100 border-orange-200 text-orange-700 hover:from-orange-100 hover:to-orange-200 shadow-sm font-medium"
              >
                Експорт CSV
              </Button>
            </div>
                ...
                showTotal: (total, range) => (
                  <div className="flex items-center justify-between w-full">
                    <div className="text-gray-600 font-medium">
                      Показано <span className="text-blue-600 font-bold">{range[0]}-{range[1]}</span> з <span className="text-gray-800 font-bold">{total}</span> записів
                    </div>
        ...
        <Modal
          ...
          footer={null}
          title={current ? `Відгук ${current.id.slice(0, 8)}...` : "Відгук"}
          width={800}
        >
          {current && (
