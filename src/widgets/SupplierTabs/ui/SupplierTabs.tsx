...
import FeedbackIcon from '../../../assets/icons/heart.svg?react';

export const TABS_SUPPLIER = [
  { key: 'home', label: 'Про продавця', icon: (active: boolean) => <UserIcon fill={active ? "#fff" : "#3E472C"} width={18} height={18}/> },
